...
/**
 * @fileoverview LEGACY Execution History drawer (snapshot for `/workflow/[id]/canvas2`).
 * Keeps the original inline-preview + in-panel node drill-down behavior. The primary `/canvas`
 * route uses RightHistoryPanel.tsx which opens the modal-based run details instead.
 * REST-backed run list with filters, live run pill, node drill-down, replay preview wiring.
 */
